...
public class EconController
{
    ...
    public void MapEndpoints(WebApplication app)
    {
        ...
        {
            var json = File.ReadAllText("JSON/defaultAvatarItems.json");
            return Results.Content(json, "application/json");
        });
        
        app.MapGet("/api/avatar/v1/defaultbaseavataritems", () =>
        {
            var json = File.ReadAllText("JSON/defaultAvatarItems.json");
            return Results.Content(json, "application/json");
        });
        ...
        app.MapGet("/econ/customAvatarItems/v1/owned", async (HttpRequest request) =>
        {
